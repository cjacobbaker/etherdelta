...
def getTrades(p_fromBlock, p_toBlock, ethereumAdress):
  file = fileOpen("trades_" +ethereumAdress+".csv", "w")
  p_static_iteration =1000
  
  p_url = "https://api.etherscan.io/api?module=logs&action=getLogs&fromBlock=$1&toBlock=\
          $2&address=0x8d12a197cb00d4747a1fe03395095ce2a5cc6819&topic0=0x6effdda786735d5033bfad5f53e5131abcced9e52be6c507b62d639685fbed6d&apikey=PWYCPV9Y82AE9HC9YVMQ7RGJZ7TS3E15MB"
...
getTrades(5225000, 5226100, '0xe8151fd80019F384502B13194A9CB6E8D592c6cB')
